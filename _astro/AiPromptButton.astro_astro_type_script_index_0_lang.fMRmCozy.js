import{n as e,t}from"./clipboard.CYJoVzbl.js";var n=`${{url:`https://artfrost1.github.io/FreimDeploy`,name:`Freim Deploy`,shortName:`Freim`,legalName:`Freim Deploy`,tagline:`Все сайты клиентов в одной панели. Без Docker.`,description:`Self-hosted платформа деплоя на ваш VPS: сборка из GitHub, автоматический HTTPS, откат в один клик и CMS-портал для клиента. Без Docker, от 1 ГБ RAM.`,lang:`ru`,locale:`ru_RU`,schemaType:`Organization`,priceRange:``,productionLeadDays:30,contact:{phone:``,phoneRaw:``,email:``},workingHours:{display:``,schema:``},address:{country:`RU`,region:``,locality:``,street:``,postalCode:``,full:``},geo:{lat:0,lng:0},social:{telegram:``,whatsapp:``,max:``,vk:``,instagram:``,youtube:``,rutube:``},ogImage:`/og/og-default.jpg`,logo:`/logo.png`,repo:`https://github.com/ARTFROST1/FreimDeploy`,starsMin:25}.url}${{agents:`/agents.md`,llms:`/llms.txt`}.agents}`,r={ru:{terminal:`Установи мне Freim Deploy на сервер и доведи до рабочей панели.
