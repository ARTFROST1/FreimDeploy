import{b as c,r as p,a as u}from"./index-DtldRnHe.js";import"./vendor-react-DqgQu83V.js";const t="fd-demo-bar",s="fdDemo.hintsHidden",b=[{href:"/projects/landing/deploys",text:"Запустите деплой и смотрите живой лог"},{href:"/projects/shop/deploys",text:"Откатитесь на прошлый релиз"},{href:"/cms",text:"Посмотрите, как клиент получает доступ к своему сайту"}];function m(){try{return sessionStorage.getItem(s)==="1"}catch{return!1}}function l(){return new URL("..",window.location.origin+c()).pathname}function g(){if(document.getElementById(t))return;const e=document.createElement("style");e.textContent=`
  ...
  `,document.head.appendChild(e);const n=document.createElement("div");n.id=t,n.setAttribute("role","status");const o=document.createElement("div"),a=document.createElement("b");a.textContent="Демо.";const r=document.createElement("span");r.textContent=" Данные вымышленные, сервера за ними нет. Изменения живут до перезагрузки страницы.",o.append(a,r);const d=document.createElement("button");d.type="button",d.textContent="Сбросить данные",d.addEventListener("click",()=>window.location.reload());const i=document.createElement("a");i.href=l(),i.textContent="Вернуться на сайт",n.append(o,d,i),document.body.appendChild(n),x()}function x(){if(p()!=="/"||m())return;const e=document.createElement("div");e.id=`${t}-hints`;const n=document.createElement("b");n.textContent="С чего начать:",e.appendChild(n);for(const a of b){const r=document.createElement("a");r.href=u(a.href),r.textContent=a.text,e.appendChild(r)}const o=document.createElement("button");o.type="button",o.textContent="Скрыть",o.addEventListener("click",()=>{e.remove(),document.body.removeAttribute("data-demo-hints");try{sessionStorage.setItem(s,"1")}catch{}}),e.appendChild(o),document.body.appendChild(e),document.body.setAttribute("data-demo-hints","")}export{g as mountDemoBanner};
